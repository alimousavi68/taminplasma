  ...
  <section id="conditions" class="relative w-full py-20 lg:py-24 bg-white overflow-hidden">
    <div
      class="container mx-auto px-4 lg:max-w-[1170px] flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-0 relative z-10">

      <!-- Right Side - Content & Interactive Conditions Grid -->
      <div
        class="w-full lg:w-[55%] flex flex-col justify-center animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 ease-out order-2 lg:order-1 relative z-20">

        <div class="space-y-6 w-full">
          <!-- Sub-header -->
          <div class="flex items-center gap-3 justify-start">
            <div class="w-8 h-8 rounded-full bg-black flex items-center justify-center shrink-0">
              <img src="public/sharayet/megaphone.png" class="w-4 h-4" alt="megaphone" />
            </div>
            <h3 class="text-neutral-900 font-black text-xl lg:text-[22px]">شرایط اهداکننده:</h3>
          </div>
      ...
      <!-- Left Side - Overlapping Visual Canvas -->
      <div
        class="w-full lg:w-[45%] relative z-10 mb-8 lg:mb-0 animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000 delay-300 ease-out order-1 lg:order-2 flex justify-end shrink-0">
        <!-- Exact 542px width for desktop -->
        <div class="relative w-full lg:w-[542px] max-w-none shrink-0">
          <!-- Main Card Box (Uncropped Image) -->
          <div class="w-full rounded-[2rem] lg:rounded-[2.5rem] overflow-hidden shadow-lg bg-neutral-200">
            <img src="public/sharayet/image 15.png" alt="زن اهداکننده پلاسما" class="w-full h-auto block" />
          </div>

          <!-- Foreground Floating Object (Exact 228px width, 114px sticking out) -->
          <div
            class="absolute -bottom-6 lg:-bottom-10 -right-6 lg:-right-[114px] z-20 w-48 md:w-56 lg:w-[228px] max-w-none filter drop-shadow-xl pointer-events-none">
            <img src="public/sharayet/Mask group.png" alt="لوله آزمایش پلاسما و گل" class="w-full h-auto" />
          </div>
        </div>
      </div>
