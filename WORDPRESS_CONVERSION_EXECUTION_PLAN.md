...
| WP-15 | انجام نشده | انطباق کامل لینک‌ها، anchorها و URLهای پویا | WP-07, WP-08, WP-10, WP-11 | 🟡 متوسط |
| WP-16 | انجام نشده | بازنویسی فرم‌ها با AJAX، Nonce و Rate Limiting | WP-08, WP-14 | 🟠 بالا |
| WP-17 | انجام نشده | انطباق اسکریپت‌های تعاملی JS با DOM نهایی وردپرس | WP-07, WP-08, WP-10, WP-11 | 🟠 بالا |
| WP-18 | انجام نشده | سخت‌گیری امنیت، Escape، Sanitize و i18n | WP-07..WP-11, WP-13..WP-16 | 🟠 بالا |
| WP-19 | انجام نشده | Migration محتوا و حذف کامل داده‌های Mock | WP-09 | 🟡 متوسط |
| WP-20 | انجام نشده | تست نهایی جامع (پاسخگویی بصری، PHP DEBUG، کنسول JS) | WP-17, WP-18, WP-19 | 🔴 بحرانی |
| WP-21 | انجام نشده | مستندسازی نهایی، ساخت فایل README.md و تحویل | WP-20 | 🟢 پایین |
...
- **مراحل WP-15 تا WP-21 در انتظار اجرا می‌باشند.**
...
- **وضعیت:** `انجام نشده`
- **وظایف:**
  - ایجاد AJAX Handlerها در `includes/ajax-handlers.php`.
...
- **وظایف:**
  ...
  - حذف تمامی آرایه‌ها و داده‌های Mock از فایل‌های کد PHP.
