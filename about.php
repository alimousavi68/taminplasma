...
<main class="w-full bg-[var(--color-bg-base)] min-h-screen font-yekan relative overflow-hidden" dir="rtl">
    ...
    <section class="relative w-full py-16 lg:py-24">
        <div class="max-w-screen-xl mx-auto px-6 lg:px-12">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                ...
                <div class="lg:col-span-6 space-y-6 text-right order-2 lg:order-1">
                ...
                <div class="lg:col-span-6 order-1 lg:order-2">
                    <div class="relative w-full aspect-[4/3] sm:aspect-[16/10] rounded-[3.5rem] overflow-hidden shadow-2xl border border-[var(--color-border-subtle)] group">
                        <img src="src/assets/about_hero.png" alt="محیط آزمایشگاهی مدرن نوژین" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-out">
    ...
    <section id="vision" class="w-full py-16 bg-[var(--color-bg-lightest)] border-y border-[var(--color-border-subtle)] relative">
        <div class="max-w-screen-xl mx-auto px-6 lg:px-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                <!-- Card: Mission -->
                <div class="bg-[var(--color-bg-surface)] border border-[var(--color-border-subtle)] rounded-[2.5rem] p-8 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group cursor-pointer flex flex-col justify-between">
                    <div>
                        <div class="w-14 h-14 rounded-2xl bg-[var(--color-bg-base)] flex items-center justify-center text-[var(--color-secondary)] mb-6 group-hover:bg-primary group-hover:text-[var(--color-text-main)] transition-colors duration-500 shadow-sm">
                            <i class="fa-solid fa-bullseye text-2xl"></i>
                        </div>
                        <h3 class="font-black text-xl text-[var(--color-text-main)] mb-3 group-hover:text-[var(--color-primary-dark)] transition-colors duration-300">مأموریت ما</h3>
                        <p class="text-xs md:text-sm text-[var(--color-text-muted)] leading-relaxed text-justify font-medium">
                ...
                <div class="bg-[var(--color-bg-surface)] border border-[var(--color-border-subtle)] rounded-[2.5rem] p-8 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group cursor-pointer flex flex-col justify-between">
                    <div>
                        ...
                        <h3 class="font-black text-xl text-[var(--color-text-main)] mb-3 group-hover:text-[var(--color-primary-dark)] transition-colors duration-300">چشم‌انداز</h3>
                        <p class="text-xs md:text-sm text-[var(--color-text-muted)] leading-relaxed text-justify font-medium">
                ...
                <div class="bg-[var(--color-bg-surface)] border border-[var(--color-border-subtle)] rounded-[2.5rem] p-8 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group cursor-pointer flex flex-col justify-between">
                    <div>
                        ...
                        <h3 class="font-black text-xl text-[var(--color-text-main)] mb-3 group-hover:text-[var(--color-primary-dark)] transition-colors duration-300">ارزش‌های ما</h3>
                        <p class="text-xs md:text-sm text-[var(--color-text-muted)] leading-relaxed text-justify font-medium">
    ...
    <section class="w-full py-16" id="about-stats-section">
        <div class="max-w-screen-xl mx-auto px-6 lg:px-12">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 text-center relative z-10">
                <!-- Stat 1 -->
                <div class="bg-primary/10 backdrop-blur-xl border border-[var(--color-primary)]/30 rounded-[2.5rem] p-8 flex flex-col items-center justify-center space-y-3 shadow-[0_8px_32px_0_rgba(255,217,112,0.15)] hover:-translate-y-2 transition-transform duration-500">
                    <div class="flex items-center text-4xl lg:text-5xl font-black text-[var(--color-text-main)]" dir="rtl">
                        <span>+</span>
                        <span class="about-counter-value" data-target="10">۰</span>
                        <span class="text-2xl lg:text-3xl mr-2">سال</span>
                    </div>
                    <span class="text-xs md:text-sm text-[var(--color-text-muted)] font-black">سابقه درخشان</span>
                </div>
                <!-- Stat 2 -->
                <div class="bg-primary/10 backdrop-blur-xl border border-[var(--color-primary)]/30 rounded-[2.5rem] p-8 flex flex-col items-center justify-center space-y-3 shadow-[0_8px_32px_0_rgba(255,217,112,0.15)] hover:-translate-y-2 transition-transform duration-500">
                    <div class="flex items-center text-4xl lg:text-5xl font-black text-[var(--color-text-main)]" dir="rtl">
                        <span>+</span>
                        <span class="about-counter-value" data-target="50">۰</span>
                        <span class="text-2xl lg:text-3xl mr-2">هزار</span>
                    </div>
                    <span class="text-xs md:text-sm text-[var(--color-text-muted)] font-black">اهداکننده وفادار</span>
                </div>
                <!-- Stat 3 -->
                <div class="bg-primary/10 backdrop-blur-xl border border-[var(--color-primary)]/30 rounded-[2.5rem] p-8 flex flex-col items-center justify-center space-y-3 shadow-[0_8px_32px_0_rgba(255,217,112,0.15)] hover:-translate-y-2 transition-transform duration-500">
                    <div class="flex items-center text-4xl lg:text-5xl font-black text-[var(--color-text-main)]" dir="rtl">
                        <span class="about-counter-value" data-target="12">۰</span>
                        <span class="text-2xl lg:text-3xl mr-2">شعبه</span>
                    </div>
                    <span class="text-xs md:text-sm text-[var(--color-text-muted)] font-black">در سراسر کشور</span>
                </div>
                <!-- Stat 4 -->
                <div class="bg-primary/10 backdrop-blur-xl border border-[var(--color-primary)]/30 rounded-[2.5rem] p-8 flex flex-col items-center justify-center space-y-3 shadow-[0_8px_32px_0_rgba(255,217,112,0.15)] hover:-translate-y-2 transition-transform duration-500">
                    <div class="flex items-center text-4xl lg:text-5xl font-black text-[var(--color-text-main)]" dir="ltr">
                        <span class="about-counter-value" data-target="100">۰</span>
                        <span class="text-3xl lg:text-4xl ml-1">٪</span>
                    </div>
                    <span class="text-xs md:text-sm text-[var(--color-text-muted)] font-black">تجهیزات مدرن</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="w-full py-16 bg-[var(--color-bg-lightest)] border-y border-[var(--color-border-subtle)]">
        <div class="max-w-screen-xl mx-auto px-6 lg:px-12">
            <h2 class="text-center font-black text-2xl lg:text-3xl text-[var(--color-text-main)] mb-12">
                استانداردها و مجوزهای بین‌المللی نوژین
            </h2>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 items-stretch">
                <!-- Badge 1 -->
                <div class="border border-[var(--color-border-subtle)] rounded-[2rem] bg-[var(--color-bg-surface)] hover:border-[var(--color-primary)] hover:shadow-lg transition-all duration-300 flex flex-col items-center justify-center p-6 text-center text-xs text-[var(--color-text-main)] font-black shadow-sm group">
                    <div class="w-12 h-12 rounded-full bg-[var(--color-bg-base)] flex items-center justify-center text-[var(--color-primary-dark)] mb-3 group-hover:scale-110 transition-transform">
    ...
    <!-- 5. GROUNDED FUNNEL CLOSER (The Secondary Theme CTA) -->
    <section class="w-full py-16 lg:py-24">
        <div class="max-w-screen-xl mx-auto px-6 lg:px-12">
            <div class="w-full bg-[var(--color-secondary)] rounded-[3.5rem] py-16 px-8 text-center text-white relative overflow-hidden shadow-2xl border border-[var(--color-border-subtle)]/20">
                <!-- Background Decoration -->
                <div class="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-[400px] h-[400px] bg-white/5 rounded-full blur-3xl pointer-events-none"></div>
                <div class="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-primary/10 rounded-full blur-3xl pointer-events-none"></div>
                
                <div class="relative z-10 max-w-3xl mx-auto space-y-6">
                    <h2 class="font-black text-2xl lg:text-4xl text-white">
                        با ما در مسیر نجات جان انسان‌ها همراه شوید
                    </h2>
                    <p class="text-[var(--color-bg-lighter)] text-sm md:text-base opacity-90 leading-loose max-w-xl mx-auto">
                    ...
                    <div class="pt-4">
                        <a href="request.php" class="bg-primary hover:bg-[var(--color-primary-hover)] text-[var(--color-text-main)] font-black px-10 py-4 rounded-full text-sm md:text-base transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-[var(--color-primary-shadow)] inline-flex items-center gap-3 cursor-pointer">
                            رزرو سریع نوبت اهدا
